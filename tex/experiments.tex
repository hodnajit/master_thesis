...
Next experimental environment was placed at Czech Technical University in Prague – Czech Institute of Informatics, Robotics, and Cybernetics (CIIRC) in the lab Intelligent and mobile robotics. Here, the localization system was evaluated using the the VICON external camera localization system \cite[vicon]. The setup with dimension and uwb localization networks can be seen in Figure \ref[fig-ciirc].
