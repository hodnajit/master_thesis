...
The localisation is the problem of estimating a robot’s coordinates in an external reference frame from sensor data, it is called state. In the state estimation algorithms more states from different sensors are fused together to counter sensors negative characteristics and support the positive ones.
