...
\secc Possible improvements of the system
	...
	* and suggest a suitable calibration process.
	...
	Another option is to use {\bf virtual sensors} that improve the precision of the entire system and are commonly used in similar applications \cite[zero_velocity1, zero_velocity2].
