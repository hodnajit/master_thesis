...
\enditems
These information can be obtained from the datasheet or AVAR (see Section \ref[chap-sec-avar]).
...
The injection of the error state is essential, but the resetting of the error state must also be done. The ES-EKF error reset operation is thus
$$
\eqalign{
